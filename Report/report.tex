...
\begin{itemize}
\item OpenSLES: Industry standard embedded audio API. Used to send all music to the system for playback. \cite{opensles}\\
\item Guava: Google Java Collections library \cite{guava}\\
\item Gson: Google Java Serialization library \cite{gson}\\
\end{itemize}
